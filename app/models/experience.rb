class Experience < ApplicationRecord
  ...
  validates :title, presence: true,length: {maximum: 20}, on: :create, allow_nil: false
  ...
  validates :incentive, presence: true,length: {maximum: 20}, on: :create, allow_nil: false
